...
function movie_template(movie){
  return `
<div class = "movie">
  <img class = movie-poster src = "${movie.poster}">

  <h2 class=movie-ame>${movie.title} 
<span class="rated">
<br>
(${movie.rated} - ${movie.type})</span></h2>
...
<h1 class = "header" >
 <strong>TENFLIX </strong></h1>

${moviesData.map(movie_template).join("")}
 


<p class = "footer" > Recently ${moviesData.length} Movies were added</p>
`